...
public class IabHelper {
    ...
    public interface OnIabSetupFinishedListener {
         ...
         */
        void onIabSetupFinished(com.eyecue.inapp.IabResult result);
    }
            ...
            public void onServiceConnected(ComponentName name, IBinder service) {
                ...
                try {
                    ...
                    if (response != BILLING_RESPONSE_RESULT_OK) {
                        if (listener != null) listener.onIabSetupFinished(new com.eyecue.inapp.IabResult(response,
                    ...
                    if (listener != null) {
                        listener.onIabSetupFinished(new com.eyecue.inapp.IabResult(IABHELPER_REMOTE_EXCEPTION,
                ...
                if (listener != null) {
                    listener.onIabSetupFinished(new com.eyecue.inapp.IabResult(BILLING_RESPONSE_RESULT_OK, "Setup successful."));
                }
            }
        };
        ...
        if (intentServices != null && !intentServices.isEmpty()) {
            ...
            if (listener != null) {
                listener.onIabSetupFinished(
                        new com.eyecue.inapp.IabResult(BILLING_RESPONSE_RESULT_BILLING_UNAVAILABLE,
    ...
    public interface OnIabPurchaseFinishedListener {
         ...
         */
        void onIabPurchaseFinished(com.eyecue.inapp.IabResult result, com.eyecue.inapp.Purchase info);
    }
    ...
    public void launchPurchaseFlow(Activity act, String sku, String itemType, List<String> oldSkus,
        ...
        com.eyecue.inapp.IabResult result;

        if (itemType.equals(ITEM_TYPE_SUBS) && !mSubscriptionsSupported) {
            com.eyecue.inapp.IabResult r = new com.eyecue.inapp.IabResult(IABHELPER_SUBSCRIPTIONS_NOT_AVAILABLE,
        ...
        try {
            ...
            if (oldSkus == null || oldSkus.isEmpty()) {
                ...
                if (!mSubscriptionUpdateSupported) {
                    com.eyecue.inapp.IabResult r = new com.eyecue.inapp.IabResult(IABHELPER_SUBSCRIPTION_UPDATE_NOT_AVAILABLE,
            ...
            if (response != BILLING_RESPONSE_RESULT_OK) {
                ...
                flagEndAsync();
                result = new com.eyecue.inapp.IabResult(response, "Unable to buy item");
            ...
            result = new com.eyecue.inapp.IabResult(IABHELPER_SEND_INTENT_FAILED, "Failed to send intent.");
            if (listener != null) listener.onIabPurchaseFinished(result, null);
        }
        catch (RemoteException e) {
            ...
            result = new com.eyecue.inapp.IabResult(IABHELPER_REMOTE_EXCEPTION, "Remote exception while starting purchase flow");
            if (listener != null) listener.onIabPurchaseFinished(result, null);
        }
    }
    ...
    public boolean handleActivityResult(int requestCode, int resultCode, Intent data) {
        ...
        if (data == null) {
            ...
            result = new com.eyecue.inapp.IabResult(IABHELPER_BAD_RESPONSE, "Null data in IAB result");
        ...
        if (resultCode == Activity.RESULT_OK && responseCode == BILLING_RESPONSE_RESULT_OK) {
            ...
            if (purchaseData == null || dataSignature == null) {
                ...
                result = new com.eyecue.inapp.IabResult(IABHELPER_UNKNOWN_ERROR, "IAB returned null purchaseData or dataSignature");
                if (mPurchaseListener != null) mPurchaseListener.onIabPurchaseFinished(result, null);
                return true;
            }

            com.eyecue.inapp.Purchase purchase = null;
            try {
                purchase = new com.eyecue.inapp.Purchase(mPurchasingItemType, purchaseData, dataSignature);
                String sku = purchase.getSku();

                // Verify signature
                if (!com.eyecue.inapp.Security.verifyPurchase(mSignatureBase64, purchaseData, dataSignature)) {
                    logError("Purchase signature verification FAILED for sku " + sku);
                    result = new com.eyecue.inapp.IabResult(IABHELPER_VERIFICATION_FAILED, "Signature verification failed for sku " + sku);
                ...
                e.printStackTrace();
                result = new com.eyecue.inapp.IabResult(IABHELPER_BAD_RESPONSE, "Failed to parse purchase data.");
                if (mPurchaseListener != null) mPurchaseListener.onIabPurchaseFinished(result, null);
                return true;
            }

            if (mPurchaseListener != null) {
                mPurchaseListener.onIabPurchaseFinished(new com.eyecue.inapp.IabResult(BILLING_RESPONSE_RESULT_OK, "Success"), purchase);
            }
        }
            ...
            if (mPurchaseListener != null) {
                result = new com.eyecue.inapp.IabResult(responseCode, "Problem purchashing item.");
                mPurchaseListener.onIabPurchaseFinished(result, null);
            }
        }
        else if (resultCode == Activity.RESULT_CANCELED) {
            logDebug("Purchase canceled - Response: " + getResponseDesc(responseCode));
            result = new com.eyecue.inapp.IabResult(IABHELPER_USER_CANCELLED, "User canceled.");
            if (mPurchaseListener != null) mPurchaseListener.onIabPurchaseFinished(result, null);
        }
        else {
            logError("Purchase failed. Result code: " + Integer.toString(resultCode)
                    + ". Response: " + getResponseDesc(responseCode));
            result = new com.eyecue.inapp.IabResult(IABHELPER_UNKNOWN_PURCHASE_RESPONSE, "Unknown purchase response.");
            if (mPurchaseListener != null) mPurchaseListener.onIabPurchaseFinished(result, null);
        }
        return true;
    }

    public com.eyecue.inapp.Inventory queryInventory() throws IabException {
     ...
     */
    public com.eyecue.inapp.Inventory queryInventory(boolean querySkuDetails, List<String> moreItemSkus,
                                                                                List<String> moreSubsSkus) throws IabException {
        checkNotDisposed();
        checkSetupDone("queryInventory");
        try {
            com.eyecue.inapp.Inventory inv = new com.eyecue.inapp.Inventory();
    ...
    public interface QueryInventoryFinishedListener {
         ...
         */
        void onQueryInventoryFinished(com.eyecue.inapp.IabResult result, com.eyecue.inapp.Inventory inv);
    }
    ...
    public void queryInventoryAsync(final boolean querySkuDetails, final List<String> moreItemSkus,
        ...
        (new Thread(new Runnable() {
            public void run() {
                com.eyecue.inapp.IabResult result = new com.eyecue.inapp.IabResult(BILLING_RESPONSE_RESULT_OK, "Inventory refresh successful.");
                com.eyecue.inapp.Inventory inv = null;
                try {
                ...
                final com.eyecue.inapp.IabResult result_f = result;
                final com.eyecue.inapp.Inventory inv_f = inv;
     ...
     */
    void consume(com.eyecue.inapp.Purchase itemInfo) throws IabException {
        checkNotDisposed();
    ...
    public interface OnConsumeFinishedListener {
         ...
         */
        void onConsumeFinished(com.eyecue.inapp.Purchase purchase, com.eyecue.inapp.IabResult result);
    }
    ...
    public interface OnConsumeMultiFinishedListener {
         ...
         *     sku.
         */
        void onConsumeMultiFinished(List<com.eyecue.inapp.Purchase> purchases, List<com.eyecue.inapp.IabResult> results);
    }
     ...
     */
    public void consumeAsync(com.eyecue.inapp.Purchase purchase, OnConsumeFinishedListener listener)
        throws IabAsyncInProgressException {
        checkNotDisposed();
        checkSetupDone("consume");
        List<com.eyecue.inapp.Purchase> purchases = new ArrayList<com.eyecue.inapp.Purchase>();
     ...
     * @param listener The listener to notify when the consumption operation finishes.
     */
    public void consumeAsync(List<com.eyecue.inapp.Purchase> purchases, OnConsumeMultiFinishedListener listener)
        throws IabAsyncInProgressException {
        checkNotDisposed();
        checkSetupDone("consume");
    ...
    int queryPurchases(com.eyecue.inapp.Inventory inv, String itemType) throws JSONException, RemoteException {
        // Query purchases
        ...
        do {
            ...
            for (int i = 0; i < purchaseDataList.size(); ++i) {
                ...
                if (com.eyecue.inapp.Security.verifyPurchase(mSignatureBase64, purchaseData, signature)) {
                    logDebug("Sku is owned: " + sku);
                    com.eyecue.inapp.Purchase purchase = new com.eyecue.inapp.Purchase(itemType, purchaseData, signature);
    ...
    int querySkuDetails(String itemType, com.eyecue.inapp.Inventory inv, List<String> moreSkus)
        ...
        for (ArrayList<String> skuPartList : packs) {
            ...
            for (String thisResponse : responseList) {
                com.eyecue.inapp.SkuDetails d = new com.eyecue.inapp.SkuDetails(itemType, thisResponse);
    ...
    void consumeAsyncInternal(final List<com.eyecue.inapp.Purchase> purchases,
        ...
        (new Thread(new Runnable() {
            public void run() {
                final List<com.eyecue.inapp.IabResult> results = new ArrayList<com.eyecue.inapp.IabResult>();
                for (com.eyecue.inapp.Purchase purchase : purchases) {
                    try {
                        consume(purchase);
                        results.add(new com.eyecue.inapp.IabResult(BILLING_RESPONSE_RESULT_OK, "Successful consume of sku " + purchase.getSku()));
                    }
                    catch (IabException ex) {
